...
const SomePage = async ({ params }: { params: { surveyUuid: string } }) => {
  const respondentUser = await getRespondent();

  // TODO: Create Organisation Form
  // If no org -> redirect to: Create Org with some data fields
  // If org -> redirect to survey directly
  return (
